...
import com.tjr.springaicombined.functions.StockQuoteFunction;
import com.tjr.springaicombined.functions.WeatherServiceFunction;
import com.tjr.springaicombined.model.Answer;
import com.tjr.springaicombined.model.Question;
import com.tjr.springaicombined.model.functions.StockPriceRequest;
import com.tjr.springaicombined.model.functions.StockPriceResponse;
import com.tjr.springaicombined.model.functions.WeatherRequest;
import com.tjr.springaicombined.model.functions.WeatherResponse;
...
public class OpenAiFunctionsServiceImpl implements OpenAIFunctionsService{
...
//                        .build()))
                        ...
                        .responseConverter(response -> {
                            String schema = ModelOptionsUtils.getJsonSchema(WeatherResponse.class.getComponentType(), false);
